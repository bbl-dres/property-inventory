// prototype-main: data load failure shows a retry; retry loads the data without duplicating listeners
module.exports = {
  name: 'main: data load failure and retry',
  boot: {
    prototype: 'prototype-main',
    url: 'http://localhost/prototype-main/',
