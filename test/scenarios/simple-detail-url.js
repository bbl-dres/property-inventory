// prototype-simple: ?view=detail opens the detail page directly; gallery deep link
module.exports = {
  name: 'simple: deep links to detail and gallery',
  boot: { prototype: 'prototype-simple', url: 'http://localhost/prototype-simple/?view=detail&id=1080%2F4840%2FAF' },
  async run(ctx, check) {
