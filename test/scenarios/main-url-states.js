...
module.exports = {
  ...
  boot: {
    ...
    url: 'http://localhost/prototype-main/?id=1000%2F4840%2FAF&table=open&filter_status=Aktiv&tableTab=parcels&basemap=aerial&topic=swisstopo&bgLayers=ch.are.bauzonen'
  },
  async run(ctx, check) {
    ...
    check('selection restored from URL', state.selectedBuildingId === '1000/4840/AF' && document.getElementById('info-panel').classList.contains('show'));
    ...
    // Direct detail link
    window.history.pushState({}, '', '/prototype-main/?view=detail&id=1000%2F4840%2FAF&tab=measurements');
