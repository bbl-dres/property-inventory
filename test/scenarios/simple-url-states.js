// prototype-simple: URL parameters restore selection, table, filters and the detail view
module.exports = {
  ...
  async run(ctx, check) {
    ...
    // Direct detail link
    window.history.pushState({}, '', '/prototype-simple/?view=detail&id=1080%2F4840%2FAF&tab=measurements');
