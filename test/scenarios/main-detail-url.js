...
module.exports = {
  ...
  boot: { prototype: 'prototype-main', url: 'http://localhost/prototype-main/?view=detail&id=1000%2F4840%2FAF' },
  async run(ctx, check) {
    ...
    check('detail content populated', document.getElementById('detail-id').textContent === '1000/4840/AF');
