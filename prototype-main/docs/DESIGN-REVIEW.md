# Design & UX Review — prototype-main
...
## 6. This prototype: prototype-main (minimal scope)
...
The single-column layout, overlines, cards and grid rows stay main-only (`app.css`).
...
**Stylesheets.** `css/styles.css` was replaced by `css/components.css` + `css/app.css` (633 lines: language
selector, table panel, filter search, phone-menu extras, detail cards, API docs, main-only responsive rules).
