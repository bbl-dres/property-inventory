...
// UI: views (map, gallery, detail, API docs), detail tabs, tools panel toggle, mobile menu,
...
// Views the Back button returns to (never the detail or API page itself)
...
function setActiveLanguageUi(lang) {
  ...
  document.querySelectorAll('.mobile-lang-pill').forEach(function(p) { p.classList.toggle('active', p.dataset.lang === lang); });
}
...
function initLanguageSelector() {
  ...
  langDropdown.addEventListener('click', function(e) {
    ...
    setActiveLanguageUi(option.dataset.lang);
  });
...
// back to the clipboard. Used by the info panel and the mobile menu.
