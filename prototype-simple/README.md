...
https://bbl-dres.github.io/property-inventory/prototype-simple/
...
Then open <http://localhost:8000/prototype-simple/> (or the repo root, which redirects).
...
npm run test:simple     # this prototype only
